 ...
 */
final class Version20210612105615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD recipient_id INT NOT NULL, CHANGE user_id sender_id INT DEFAULT NULL, CHANGE etat is_read TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP recipient_id, CHANGE sender_id user_id INT DEFAULT NULL, CHANGE is_read etat TINYINT(1) NOT NULL');
